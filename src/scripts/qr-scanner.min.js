...
else{let d,f;d=()=>{a.removeEventListener("load",d);a.removeEventListener("error",f);c()};f=()=>{a.removeEventListener("load",d);a.removeEventListener("error",f);b("Image load error")};a.addEventListener("load",d);a.addEventListener("error",f)}})}}e.DEFAULT_CANVAS_SIZE=400;e.WORKER_PATH="../../scripts/qr-scanner-worker.min.js";export default e;
//# sourceMappingURL=qr-scanner.min.js.map../../scripts/qr-scanner-worker.min.js